      ...
      <div className="card">
        <div className="card-header">
          <div
            ...
            style={{
              backgroundImage: `url(${require('../assets/images/360_F_612316958_ueScrCOjrNBIuDMpiVt6UI3F8dkk6IWI.jpg')})`,
            }}
          ></div>
          <img
            className="card-avatar"
            src={require('../assets/images/281553601_1200625580678473_5285464895107595026_n.jpg')}
            alt="avatar"
            onError={(e) => {
              console.error('Avatar image failed to load:', e);
              e.target.src = 'https://via.placeholder.com/100'; // Placeholder nếu lỗi
            }}
          />
          <h1 className="card-fullname">Mac Do Gia Huy</h1>
        ...
        <div className="card-main">
          ...
          <div
            className={`card-section ${
              activeTab === 'experience' ? 'is-active' : ''
            }`}
            id="experience"
          >
            <div className="card-content">
              ...
              <div className="card-timeline">
                <div className="card-item" data-year="2016">
                  <div className="card-item-title">
                    Started programing at <span>Hackerank</span>
                  </div>
                ...
                <div className="card-item" data-year="2018">
                  <div className="card-item-title">
                    Game Developer at <span>Skygo</span>
                  </div>
                  <div className="card-item-desc">
                ...
                <div className="card-item" data-year="2021">
                  <div className="card-item-title">
                    Embedding Engineer at <span>FPT software</span>
                  </div>
                  <div className="card-item-desc">
                ...
                <div className="card-item" data-year="2023">
                  <div className="card-item-title">
                    Full-Stack Developer at <span>Everfit</span>
                  </div>
                  <div className="card-item-desc">
                    Responsible for the encompassing brand experience.
                  </div>
                </div>
              </div>
            </div>
